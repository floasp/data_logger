class DesktopLayout_new{
    ...
    addToManager(widgetmanager){
        widgetmanager.addWidget(this.gwidget_temp, 0, 0, 10, 2)
        widgetmanager.addWidget(this.gwidget_humi, 0, 2, 10, 2)
    
        widgetmanager.addWidget(this.lvwidget_temp, 10, 0, 2, 2);
        widgetmanager.addWidget(this.lvwidget_humi, 10, 2, 2, 2);
    
        widgetmanager.addWidget(this.hwidget_temp, 12, 0, 2, 2);
        widgetmanager.addWidget(this.hwidget_humi, 12, 2, 2, 2);
        
        widgetmanager.addWidget(this.ngwidget_temp_minmax, 0, 4, 10, 2);
    }
